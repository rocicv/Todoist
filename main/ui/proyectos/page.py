...
class ProyectPage:
    ...
    def agregar_proyecto(self, titulo:str):
        ...
        self.elements.get_campo_nombre_titulo().is_visible()
        logger.info('campo visible')
        self.elements.get_campo_nombre_titulo().fill(titulo)
        logger.info('introduciendo campos')
    ...
    def actualizar_info(self):
        ...
        self.elements.get_campo_nombre_titulo()
    ...
    def exportar(self):
        ...
        logger.info("proyecto exportado")
